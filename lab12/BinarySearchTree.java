...
public class BinarySearchTree<T> implements Iterable<T>
{
  ...
  public T min2rec(BSTNode<T> root){
	  //IMPLEMENT THE RECURSIVE ALGORITHM HERE
  }
  
  public int leafCount(){
	  //IMPLEMENT THE ITERATIVE ALGORITHM HERE
  }
  ...
  // comp.compare(target, i) == 0; otherwise, returns false.
 {
  ...
  {
    final ArrayDeque<T> infoQueue = new ArrayDeque<T>();
